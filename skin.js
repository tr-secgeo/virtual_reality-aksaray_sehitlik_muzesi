...
function pano2vrSkin(player,base) {
	...
	player.addVariable('asm_vis_show', 2, false, { ignoreInState: 0  });
	player.addVariable('asm_show_plan', 2, false, { ignoreInState: 0  });
	...
	player.addVariable('asm_vis_phone_image', 2, false, { ignoreInState: 0  });
	...
	player.addVariable('asm_open_image_hotspots', 0, "", { ignoreInState: 0  });
	player.addVariable('vis_info', 2, false, { ignoreInState: 0  });
	player.addVariable('asm_vis_hotspots', 2, true, { ignoreInState: 0  });
	player.addVariable('vis_info_popup', 2, false, { ignoreInState: 0  });
	player.addVariable('asm_resp_phone', 2, false, { ignoreInState: 1  });
	player.addVariable('asm_info', 2, false, { ignoreInState: 0  });
	player.addVariable('asm_vis_skin', 2, false, { ignoreInState: 1  });
	...
	this.addSkin=function() {
		...
		me._variable_asm_resp_phone = {};
		me._variable_asm_resp_phone.ggCurrentLogicState = -1;
		me._variable_asm_resp_phone.logicBlock = function() {
			var newLogicState_asm_resp_phone;
			if (
				((player.getViewerSize(true).width <= 1024))
			)
			{
				newLogicState_asm_resp_phone = 0;
			}
			else {
				newLogicState_asm_resp_phone = -1;
			}
			if (me._variable_asm_resp_phone.ggCurrentLogicState != newLogicState_asm_resp_phone) {
				me._variable_asm_resp_phone.ggCurrentLogicState = newLogicState_asm_resp_phone;
				if (me._variable_asm_resp_phone.ggCurrentLogicState == 0) {
					player.setVariableValue('asm_resp_phone', true);
				}
				else {
					player.setVariableValue('asm_resp_phone', false);
				}
			}
		}
		me._variable_asm_vis_skin = {};
		me._variable_asm_vis_skin.ggCurrentLogicState = -1;
		me._variable_asm_vis_skin.logicBlock = function() {
			var newLogicState_asm_vis_skin;
			if (
			...
			{
				newLogicState_asm_vis_skin = 0;
			}
			else {
				newLogicState_asm_vis_skin = -1;
			}
			if (me._variable_asm_vis_skin.ggCurrentLogicState != newLogicState_asm_vis_skin) {
				me._variable_asm_vis_skin.ggCurrentLogicState = newLogicState_asm_vis_skin;
				if (me._variable_asm_vis_skin.ggCurrentLogicState == 0) {
					player.setVariableValue('asm_vis_skin', true);
				}
				else {
					player.setVariableValue('asm_vis_skin', false);
				}
			}
		}
		...
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			'';
		...
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
		...
		me._show_backround.logicBlock_position = function() {
			...
			if (me._show_backround.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._show_backround.ggCurrentLogicStatePosition == 0) {
					...
					me._show_backround.style.left='10px';
					me._show_backround.style.bottom='-265px';
				}
			}
		}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			'IDQ5IDMwIGMzMCAxOSA2MCA0OSA3OSA3OSBsMzAgNDkgMCAyMzk3IDAgMjM5NyAtMzAgNDkgYy0xOSAzMCAtNDkgNjAgLTc5IDc5IGwtNDkgMzAgLTIzODEgMiBjLTE5MjkgMiAtMjM4OCAwIC0yNDE3IC0xMXoiIGZpbGw9IiM1NWFhZmYiIGZpbGwtb3BhY2l0eT0iMSIvPgogPC9nPgo8L3N2Zz4K';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._asm_kat_plani.onclick=function (e) {
			player.setVariableValue('asm_show_plan', !player.getVariableValue('asm_show_plan'));
		}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'cz0iY2xzLTIiLz4KIDxsaW5lIHkxPSI0LjM2IiB4Mj0iOC4xOCIgeTI9IjIxLjU1IiBjbGFzcz0iY2xzLTEiIHgxPSI4LjE4Ii8+CiA8bGluZSB5MT0iMi40NSIgeDI9IjE1LjgyIiB5Mj0iMTIiIGNsYXNzPSJjbHMtMSIgeDE9IjE1LjgyIi8+Cjwvc3ZnPgo=';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'cz0iY2xzLTIiLz4KIDxsaW5lIHkxPSI0LjM2IiB4Mj0iOC4xOCIgeTI9IjIxLjU1IiBjbGFzcz0iY2xzLTEiIHgxPSI4LjE4Ii8+CiA8bGluZSB5MT0iMi40NSIgeDI9IjE1LjgyIiB5Mj0iMTIiIGNsYXNzPSJjbHMtMSIgeDE9IjE1LjgyIi8+Cjwvc3ZnPgo=';
		...
		me._asm_map.onclick=function (e) {
			player.setVariableValue('asm_vis_show', !player.getVariableValue('asm_vis_show'));
		}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			'';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			'0iZXZlbm9kZCIvPgo8L3N2Zz4K';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			'c+Cg==';
		...
		me._asm_p_map_1.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('asm_vis_show') == true))
			)
			{
				newLogicStatePosition = 0;
			}
		...
		me._asm_kat_map_1.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('asm_show_plan') == true))
			)
			{
				newLogicStatePosition = 0;
			}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			'';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'LTExIDg4IC0xOSAxNjAgLTE4IDE2MSAxIDEgNDEgMjAgODkgNDIgMjI3IDEwNSA0MTIgMjg0IDUyNCA1MDQgNDEgODEgNDUgMTQxIDEzIDE4MiAtMzggNDkgLTEwMiA2OCAtMTU1IDQ2eiIgZmlsbD0iIzU1YWFmZiIgZmlsbC1vcGFjaXR5PSIxIi8+CiA8L2c+Cjwvc3ZnPgo=';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'';
		...
		me._asm_p_map_1.ggClearMapMarkers=function() {
			...
			var id,marker;
			var markers=me._asm_p_map_1.ggMarkerArray;
			for (id in markers) {
		...
		me._asm_p_map_1.ggInitMapMarkers=function(updateMapBounds) {
			...
			for(var i=0;i<ids.length;i++) {
				...
				if ((gps.length>=2) && ((gps[0]!=0) || (gps[1]!=0))) {
					...
					me._asm_p_map_1.ggMarkerArray[id]=marker;
					me._asm_p_map_1.ggMarkerInstances.push(div);
		...
		me._asm_kat_map_1.ggInitMapMarkers=function() {
			...
			for(var i=0; i < ids.length; i++) {
				...
				var coords = player.getNodeMapCoordsInPercent(id, me._asm_kat_map_1.ggMapId);
				if (coords.length>=2) {
					me._asm_kat_map_1.ggHMarkerAnchorOffset = 0;
					me._asm_kat_map_1.ggVMarkerAnchorOffset = 24;
					var markerParent = new Object();
					markerParent.ggElementNodeId=function() { return id };
					var markerClass = new SkinElement_kat_pin_Class(me, markerParent);
					me._asm_kat_map_1.ggMarkerInstances.push(markerClass);
					var marker = markerClass._kat_pin;
		...
		player.addListener('changenode', function(event) {
			...
			me._variable_asm_vis_skin.logicBlock();
		...
		player.addListener('sizechanged', function(event) {
			me._variable_asm_resp_phone.logicBlock();
		...
		player.addListener('varchanged_asm_show_plan', function(event) {
			me._asm_kat_map_1.logicBlock_position();
		});
		player.addListener('varchanged_asm_vis_show', function(event) {
			me._asm_p_map_1.logicBlock_position();
		});
	...
	function SkinElement_kat_pin_Class(parentScope,ggParent) {
		var me=this;
		var flag=false;
		...
		el=me._kat_pin=document.createElement('div');
		els=me._kat_pin__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'';
		me._kat_pin__img.setAttribute('src',hs);
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		els.setAttribute('style', hs);
		els['ondragstart']=function() { return false; };
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._kat_pin.ggIsActive=function() {
		...
		me._kat_pin.onclick=function (e) {
			player.openNext("{"+me.ggNodeId+"}",player.hotspot.target);
		}
		me._kat_pin.ggUpdatePosition=function (useTransition) {
		}
	};
	...
	function SkinHotspotClass_ht_image(parentScope,hotspot) {
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'IvPgogPGxpbmUgeTE9IjEzIiB4Mj0iOCIgeTI9IjEzIiB4MT0iMTYiLz4KIDxsaW5lIHkxPSIxNyIgeDI9IjgiIHkyPSIxNyIgeDE9IjE2Ii8+CiA8cG9seWxpbmUgcG9pbnRzPSIxMCA5IDkgOSA4IDkiLz4KPC9zdmc+Cg==';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'IxMyIgeDI9IjgiIHkyPSIxMyIgeDE9IjE2Ii8+CiA8bGluZSB5MT0iMTciIHgyPSI4IiB5Mj0iMTciIHgxPSIxNiIvPgogPHBvbHlsaW5lIHBvaW50cz0iMTAgOSA5IDkgOCA5Ii8+Cjwvc3ZnPgo=';
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
